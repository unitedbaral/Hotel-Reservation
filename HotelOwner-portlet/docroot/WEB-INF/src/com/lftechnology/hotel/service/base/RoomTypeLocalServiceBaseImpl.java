...
import com.lftechnology.hotel.service.RoomLocalService;
import com.lftechnology.hotel.service.RoomService;
import com.lftechnology.hotel.service.RoomTypeLocalService;
import com.lftechnology.hotel.service.RoomTypeService;
import com.lftechnology.hotel.service.persistence.RoomPersistence;
import com.lftechnology.hotel.service.persistence.RoomTypePersistence;
...
/**
 * The base implementation of the room type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lftechnology.hotel.service.impl.RoomTypeLocalServiceImpl}.
 * </p>
 *
 * @author ranjan
...
public abstract class RoomTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements RoomTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lftechnology.hotel.service.RoomTypeLocalServiceUtil} to access the room type local service.
	 */
	...
	public RoomType addRoomType(RoomType roomType) throws SystemException {
		roomType.setNew(true);

		return roomTypePersistence.update(roomType, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RoomType deleteRoomType(RoomType roomType) throws SystemException {
	...
	public RoomType fetchRoomType(long roomtypeId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRoomTypesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RoomType updateRoomType(RoomType roomType) throws SystemException {
		return updateRoomType(roomType, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RoomType updateRoomType(RoomType roomType, boolean merge)
		throws SystemException {
		roomType.setNew(false);

		return roomTypePersistence.update(roomType, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.lftechnology.hotel.model.RoomType",
	...
	private RoomTypeLocalServiceClpInvoker _clpInvoker = new RoomTypeLocalServiceClpInvoker();
}